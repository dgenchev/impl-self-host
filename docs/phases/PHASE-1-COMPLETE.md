...
### 2. Set Up Supabase 🗄️
Follow the guide: `docs/setup/supabase-setup.md`
...
Follow the guide: `docs/setup/telegram-setup.md`
...
Follow the guide: `docs/setup/environment-setup.md`
...
1. **Supabase Issues**: 
   - Check docs/setup/supabase-setup.md troubleshooting section
