...
2. Click **"New query"**
3. Copy and paste the SQL schema from `docs/setup/database-schema.sql` OR use the schema below:
...
- Make sure you ran the SQL schema completely (from `docs/setup/database-schema.sql`)
...
2. → Continue with Telegram bot setup (see `docs/setup/telegram-setup.md`)
